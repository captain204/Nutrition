          ...
          <div class="row w-100">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <h2>Register</h2>
                 <form  action="<?=base_url('clinic/register');?>" method="post">
                        <?php echo validation_errors('<div class ="alert alert-danger">','</div>');?>
                    <div class="form-group">
                      <label for="clinic_name">Clinic Name</label>
                      <input type="text" name="clinic_name" class="form-control" " aria-describedby="emailHelp" placeholder="Enter the name of your clinic" required="required">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="address" class="form-control" " aria-describedby="emailHelp" placeholder="Enter your Address" required="required">
                      <i class="mdi mdi-account"></i>
                    </div>
                    <div class="form-group">
                      <label for="phone">Phone</label>
                      <input type="text" name="phone" class="form-control" " aria-describedby="emailHelp" placeholder="Enter your phone number" required="required">
                      <i class="mdi mdi-account"></i>
                    </div>
                    <div class="mt-5">
