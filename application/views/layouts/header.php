      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url();?>admin/create_action">
            ...
            <li class="nav-item nav-category">
              <span class="nav-link">Manage Clinics</span>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url();?>clinic/create">
                <span class="menu-title">Add clinic</span>
                <i class="icon-flag menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url();?>clinic">
